...
public class ProcReader {
    ...
    public synchronized void update() {
        ...
        double diffCall = (newCall - lastCall) / 1000.0; 
        ...
        if (output != null && output != "") {
            ...
            diskTotal = "" + (size / (1024.0 * 1024.0)); 
            diskUsed = "" + (used / (1024.0 * 1024.0)); 
            diskFree = "" + (available / (1024.0 * 1024.0)); 
                                                                
            diskUsage = "" + (usage * 1.0 / nr); 
        } else { 
